...
//const  = nestedMuppet.album.theMuppetMovie.song2;
...
const bessie = farmAnimals2[0];
const dolly = farmAnimals2[2];
const babe = farmAnimals2[3];
const little = farmAnimals2[4];


const farmAnimals3 = [];
farmAnimals3.push(blackAndWhite, black, pink);
